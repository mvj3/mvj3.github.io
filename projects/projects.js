...
$(document).ready(function() {
  ...
  var title_template = _.template("<div>"
    + "I'm David Chen, aka <a href='https://github.com/mvj3' target='_blank'>@mvj3</a>, have created <b><%= open_source_by_self %> open source projects</b> and forked <b><%= open_source_by_fork %></b> projects in my daily jobs since 2009."
    + " I really enjoy it, after 2013, I used to write proprietary business code and open source code <b>concurrently</b> and <b>modularly</b>."
    + "</br>"
    + "</br>"
